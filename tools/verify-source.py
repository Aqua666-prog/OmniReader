...
assert 'versionCode = 8' in (root/'app/build.gradle.kts').read_text()
assert 'versionName = "0.8.0"' in (root/'app/build.gradle.kts').read_text()
print('Version 0.8.0 / 8 verified')
